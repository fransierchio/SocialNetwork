        ...
        while (true) 
        {
            if (ismouseclick(WM_LBUTTONDOWN)) 
            {
                ...
                if (clicEnRectangulo(750, 640, 1365, 700, x, y)) {
                    ...
                    {
                        oculto=false;
                        setbkcolor(COLOR(0xdd,0xdd,0xdd));
                        setfillstyle(SOLID_FILL,COLOR(0xdd,0xdd,0xdd));
                        setcolor(BLACK);
                        escribirEnCampo(720, 640, 1365, 690,mensaje, 19, indexMensaje, oculto);
                    }
                }

                //enviar Mensaje
                if (clicEnRectangulo(1385, 640, 1440, 700, x, y)) {
                    if(codigoDos!=999 && indexMensaje>0)
                    {
                        Usuarios::enviarMensaje(ID,codigoDos,mensaje);
                        setfillstyle(SOLID_FILL,COLOR(0xf3,0xf3,0xf3));
                        bar(640,140,1495,625);
                        UserPrincipal.consultarMensajes(codigoDos);
                        limpiarChar(mensaje,20);
                        indexMensaje=0;
                        setfillstyle(SOLID_FILL,COLOR(0xdd,0xdd,0xdd));
                        bar(780,650,1340,690);
                    }
                }
                
                //ingresar usaurioi
                if (clicEnRectangulo(220, 125, 540, 170, x, y)) {
                    setfillstyle(SOLID_FILL,COLOR(0xf3,0xf3,0xf3));
                    bar(640,140,1495,625);
                    bar(700,25,1395,125);
                    setfillstyle(SOLID_FILL,COLOR(0xdd,0xdd,0xdd));
                    ...
                    oculto=false;
                    codigoDos=999;
                    setbkcolor(COLOR(0x2d,0x2e,0x30));
                    setfillstyle(SOLID_FILL,COLOR(0x2d,0x2e,0x30));
                    setcolor(WHITE);
                    escribirEnCampo(200, 125, 540, 162,user, 13, indexUser, oculto);
                    Usuarios::extraerCodigo(user,codigoDos);
                    setbkcolor(COLOR(0xf3,0xf3,0xf3));
                    setfillstyle(SOLID_FILL,COLOR(0xf3,0xf3,0xf3));
                    setcolor(BLACK);
                    Usuarios::mostrarIconoChat(codigoDos);
                    UserPrincipal.consultarMensajes(codigoDos);
                }
